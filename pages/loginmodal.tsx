  ...
  return (
    <div>
      <div className="flex items-center justify-center min-h-screen bg-rose-50">
        {/* Card Container Delete m-6 and md:m-0*/}
        <div className="relative flex flex-col space-y-10 bg-white shadow-2xl rounded-2xl md:flex-row md:space-y-0">
          {/* Left Side */}
          <div className="p-6 md:p-20">
            ...
            <div className="flex flex-col space-x-0 space-y-6 md:flex-row md:space-x-4 md:space-y-0">
              ...
              hover:bg-opacity-30 hover:shadow-lg hover:-translate-y-0.5 ransition duration-150 md:w-1/2"
              >
            ...
            <div className="flex font-light items-center justify-center mt-4">
          ...
          {/* Right Side */}
          <img src="image55.jpg" alt="" className="w-[430px] hidden md:block" />
          {/* Close button */}
          <div className="group absolute -top-5 right-4 flex items-center justify-center w-10 h-10 bg-gray-100 rounded-full md:bg-white md:top-4 hover:cursor-pointer hover:-translate-y-0.5 transition duration-150">
            <svg
              xmlns="http://www.w3.org/2000/svg"
